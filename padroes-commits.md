# Padrões de Commits
O commit é a ação de transformar mudanças temporárias em permanentes, encerrando uma transação com êxito e assegurando a durabilidade dos dados, propriedade do modelo ACID.
Para facilitar a organização e eficiência das equipes, a Conventional Commits estabeleceu uma padronização para as mensagens de commit, impactando positivamente no desenvolvimento de software.
